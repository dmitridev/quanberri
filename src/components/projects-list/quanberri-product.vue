  ...
  <div class="product product-style" :id="props.id">
    <div class="product-img">
      <div class="header-container">
        <svg width="20" height="46" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect y="16" width="2" height="2" fill="white"></rect>
          ...
          <rect x="4" y="8" width="2" height="2" fill="white"></rect>
          <rect x="2" y="6" width="2" height="2" fill="white"></rect>
          <rect y="4" width="2" height="2" fill="white"></rect>
        </svg>
...
onMounted(async () => {
  ...
  productImgRef.value.style = `max-width:100%;max-height:757px;width:590px;height:472px`;
  const vs = `
